...
#       return "en" # Force to "english" language
        return lang
...
def _install(domain, localedir, asglobal=False, lang = False):
    '''
    :param domain: translation domain
...
def install(domain, localedir, lang = False):
    '''
    :param domain: translation domain
    :param localedir: locale directory
    ...
    '''
    _install(domain, localedir, True, lang)
