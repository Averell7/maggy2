...
def convert_rtf_hexcode(string1) :
    ...
    exec(f1.getvalue())
    f1.close()
    c = unicode2(b)   #Â£  Is this correct ??
    return c
...
or the list does not exist."""))
        ...
        for  i in range(len(clists))  :
            ...
            if i > 0 :
                # TODO: added to speed up the focus we will see later
...
##                    entry.connect('changed', self.additional_data,right,field,index)
        ...
        left.drag_source_add_text_targets()
        right.drag_dest_add_text_targets()
    ...
    def drag_data_get_data(self, treeview, context, data, target_id, etime)  :
        ...
        data.set_text(data1, 10)                #Â£ is -1 the right value ?
            ...
            if 'width' in coldef[key] :
                if coldef[key]['width'] != "" :     # if a width is defined for the column
                    ...
                    if 'options' in coldef[key] :
                        ...
                        if pango == 1 :
                            coltype = 'markup';     # set markup instead of text to use pango
...
## self.refresh_list2(tab);
    ...
    def detail_liste(self, selection) :
        ...
        # if there is no selection, we delete
...
## values[18] = '#bb88bb' # background
    ...
    def inverser(self, widget) :
        ...
        for key in todo_a :
            ...
            if gateway != None :
                # check the existence of the i_data field and create it if needed.
...
## link.commit()
        ...
        #check the existence / creation of the field :
        ...
        for key in todo_a :
            ...
            if gateway != None :            # tables with gateway
                ...
                if linked_field == None :
                    print(_("linked field not present for ") + key)   # TODO: specify the message
                    continue
                req1 = "update $central_table set $fieldname = ("
                req1 += "select $name from $table "
...
## req1 += "where $central_table.$main_field = $gateway.$main_field )"
                    ...
                    if linked_field == None or linked_field.strip() == "":
                        print(_("linked field not present"))   # TODO: specify the message
                        continue
...
## cursor.execute(req)
        ...
        field = 'g_' + table # check the presence of the field
    ...
    def periph_delete(self, treeview)  :
        ...
        sel=self.arw[liste].get_selection() # check that there is a selected line.
        (model, arPaths) = sel.get_selected_rows()
        n3=len(arPaths)
...
## alert(_("The file queries-od.py is invalid"))
    ...
    # Display in the right frame
        ...
        else :                  # if there is no selection, we delete
            effacer = 1
            iter = null
...
## self.arw[window].hide()
        ...
        # add columns Ã  la liste de sélection des colonnes
        cell_renderer = Gtk.CellRendererText();
...
## fx.close()
        ...
        self.police(self.arw,self.fonte1);       # initialization de la taille des polices pour tous les objets
...
## width = ""
        ...
        if mem['config_liste'][page] == 0 :         # if list not yet configured
            for k in range(0,40) :
                ...
                # set markup instead of text to use pango
                else :
...
## alert(result);
        ...
        for i in range(0, lignes) :
            for j in range(0, num_colonnes) :
                ...
                if j in col :         # if a criteria is defined
                    ...
                    v2 = v2.lower()                  # case insensitive sorting
                    ...
                    if alpha[j]=='n' :                      # numerical sorting
                        temp[j]=temp[j].rjust(10,'0')


                    if ascen[j]=='-' and alpha[j]=='n' :    # numerical sorting descendant
    ...
    def ________________DETAIL______________() :
        pass
    # =========================================================
    # The following functions manage the display in the details area
    # ==========================================================#
    """==============================================================================
    FONCTION   : Detail
